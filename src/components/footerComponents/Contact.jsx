...
const Contact = () => {
  return (
    <div className="bg-[#050505] p-6 h-full w-full grid grid-rows-3 md:grid-cols-2 md:grid-rows-4 justify-center items-center gap-10">
        ...
        <a href='https://wa.me/5541987868768' target="_blank" rel="noopener noreferrer" className="px-4 py-3 hover:opacity-80 bg-[#E8EDF0] justify-self-end rounded-lg font-playpen">Hire Diego</a>
