...
const Works = () => {
  return (
    <div id="Projects" className="bg-[#050505] w-full h-full grid grid-cols-1 grid-rows-1 md:grid-cols-2 md:grid-rows-3 p-10 justify-center items-center pt-0.5">
        <img className="w-20 hidden md:relative md:flex left-12 top-20" src="/star.png" alt="star" />
        ...
        <img className=" p-3 md:p-10 md:row-start-1 row-start-1 md:row-span-3" src="/total-1-ew.png" alt="project 1" />
    </div>
  )
}
